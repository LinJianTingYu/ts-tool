...
// 1.邮箱
var isEmail = exports.isEmail = function isEmail(s) {
    return (/^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+((.[a-zA-Z0-9_-]{2,3}){1,2})$/.test(s));
};
// 2.手机号码
var isMobile = exports.isMobile = function isMobile(s) {
    return (/^1[0-9]{10}$/.test(s + ''));
};
// 3.电话号码
var isPhone = exports.isPhone = function isPhone(s) {
...
// 7.是否boolean
var isBoolean = exports.isBoolean = function isBoolean(o) {
...
// 10.是否undefined
var isUndefined = exports.isUndefined = function isUndefined(o) {
...
14; // .是否正则
var isRegExp = exports.isRegExp = function isRegExp(o) {
    return Object.prototype.toString.call(o).slice(8, -1) === 'RegExp';
};
// 15.是否错误对象
var isError = exports.isError = function isError(o) {
    return Object.prototype.toString.call(o).slice(8, -1) === 'Error';
};
// 16.是否Symbol函数
var isSymbol = exports.isSymbol = function isSymbol(o) {
...
// 19.是否是微信浏览器
var isWeiXin = exports.isWeiXin = function isWeiXin(ua) {
    return ua.match(/microMessenger/i) == 'micromessenger';
};
// 20.是否是移动端
var isDeviceMobile = exports.isDeviceMobile = function isDeviceMobile(ua) {
    return (/android|webos|iphone|ipod|balckberry/i.test(ua));
};
// 21.是否是QQ浏览器
var isQQBrowser = exports.isQQBrowser = function isQQBrowser(ua) {
    return !!ua.match(/mqqbrowser|qzone|qqbrowser|qbwebviewtype/i);
};
// 22.是否是爬虫
var isSpider = exports.isSpider = function isSpider(ua) {
...
// 37.判断类型集合
var checkStr = exports.checkStr = function checkStr(str, type) {
    switch (type) {
        case 'phone':
            //手机号码
...
// 40.将阿拉伯数字翻译成中文的大写数字
var numberToChinese = exports.numberToChinese = function numberToChinese(num) {
...
// 41.将数字转换为大写金额
var changeToChinese = exports.changeToChinese = function changeToChinese(Num) {
...
// 42.判断一个元素是否在数组中
var contains = exports.contains = function contains(arr, val) {
...
// 58.判断两个对象是否键值相同
var isObjectEqual = exports.isObjectEqual = function isObjectEqual(a, b) {
...
var colorToRGB = exports.colorToRGB = function colorToRGB(val, opa) {
...
// 60.追加url参数
var appendQuery = exports.appendQuery = function appendQuery(url, params) {
    var query = '';
    for (var k in params) {
        query += '&' + k + '=' + params[k];
    }
